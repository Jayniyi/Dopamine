<template>
<button class="cursor-pointer font-semibold overflow-hidden relative z-100 border border-white-500 group px-7 py-2">
  <span class="relative z-10 text-white group-hover:text-blue-900 text-xl duration-500">Contact Me!</span>
