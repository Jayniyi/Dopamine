...
.animate-blink {
  ...
  <!-- <div class="w-96 lg:w-full lg:p-32">
    <svg
      viewBox="0 0 1055 161"
      class="react-activity-calendar__calendar styles_calendar__1s6ps"
    >
      <g class="react-activity-calendar__legend-month" style="font-size: 16px">
        <text x="40" alignment-baseline="hanging">Jan</text>
        <text x="120" alignment-baseline="hanging">Feb</text>
        <text x="200" alignment-baseline="hanging">Mar</text>
        <text x="300" alignment-baseline="hanging">Apr</text>
        <text x="380" alignment-baseline="hanging">May</text>
        <text x="460" alignment-baseline="hanging">Jun</text>
        <text x="560" alignment-baseline="hanging">Jul</text>
        <text x="640" alignment-baseline="hanging">Aug</text>
        <text x="720" alignment-baseline="hanging">Sep</text>
        <text x="820" alignment-baseline="hanging">Oct</text>
        <text x="900" alignment-baseline="hanging">Nov</text>
        <text x="980" alignment-baseline="hanging">Dec</text>
      </g>
      <g transform="translate(0, 0)">
        <rect
          ...
          width="15"
          height="15"
          fill="hsla(272, 85%, 74%, 0.44)"
          rx="2"
          ry="2"
          class="styles_block__1oBAV"
